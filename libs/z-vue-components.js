...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.z-navbar[data-v-8] {\n  box-sizing: border-box;\n  background-color: #fff;\n  box-shadow: 0 0 4px rgba(0,0,0,0.25);\n  width: 100%;\n}\n.z-navbar-fix[data-v-8] {\n  position: fixed;\n  top: 0;\n  z-index: 9999;\n}\n", "", {"version":3,"sources":["/./src/components/Navbar.vue?55725368"],"names":[],"mappings":";AA8BA;EACA,uBAAA;EACA,uBAAA;EACA,qCAAA;EACA,YAAA;CACA;AACA;EACA,gBAAA;EACA,OAAA;EACA,cAAA;CACA","file":"Navbar.vue","sourcesContent":["<template lang=\"html\">\n  <div class=\"z-navbar-wraper\">\n    <div class=\"z-navbar-placeholder\" :style=\"{height: isFixed ? navbarHeight + 'px' : ''}\">\n    </div>\n    <div class=\"z-navbar\" :class=\"{'z-navbar-fix': isFixed}\">\n      <slot></slot>\n    </div>\n  </div>\n</template>\n\n<script>\nexport default {\n  data() {\n    return {\n      navbarHeight: \"\"\n    }\n  },\n  props: {\n    isFixed: {\n      type: Boolean,\n      default: false\n    }\n  },\n  mounted() {\n    this.navbarHeight = this.$el.lastChild.clientHeight\n  }\n};\n</script>\n\n<style lang=\"css\" scoped>\n.z-navbar {\n  box-sizing: border-box;\n  background-color: #fff;\n  box-shadow: 0 0 4px rgba(0,0,0,0.25);\n  width: 100%;\n}\n.z-navbar-fix {\n  position: fixed;\n  top: 0;\n  z-index: 9999;\n}\n</style>\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/.npminstall/css-loader/0.23.1/css-loader/index.js?sourceMap!./../../node_modules/.npminstall/vue-loader/9.5.1/vue-loader/lib/style-rewriter.js?id=data-v-6&scoped=true!./../../node_modules/.npminstall/vue-loader/9.5.1/vue-loader/lib/selector.js?type=styles&index=0!./Switch.vue", function() {
				var newContent = require("!!./../../node_modules/.npminstall/css-loader/0.23.1/css-loader/index.js?sourceMap!./../../node_modules/.npminstall/vue-loader/9.5.1/vue-loader/lib/style-rewriter.js?id=data-v-6&scoped=true!./../../node_modules/.npminstall/vue-loader/9.5.1/vue-loader/lib/selector.js?type=styles&index=0!./Switch.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/.npminstall/css-loader/0.23.1/css-loader/index.js?sourceMap!./../../node_modules/.npminstall/vue-loader/9.5.1/vue-loader/lib/style-rewriter.js?id=data-v-7&scoped=true!./../../node_modules/.npminstall/vue-loader/9.5.1/vue-loader/lib/selector.js?type=styles&index=0!./Table.vue", function() {
				var newContent = require("!!./../../node_modules/.npminstall/css-loader/0.23.1/css-loader/index.js?sourceMap!./../../node_modules/.npminstall/vue-loader/9.5.1/vue-loader/lib/style-rewriter.js?id=data-v-7&scoped=true!./../../node_modules/.npminstall/vue-loader/9.5.1/vue-loader/lib/selector.js?type=styles&index=0!./Table.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
